...
with tab2:
    ...
    default_rows = pd.DataFrame([
        {"ETF 종목": "RISE 미국배당100데일리고정커버드콜",          "예상 투자금 (원)": "140,000,000"},
        {"ETF 종목": "KODEX 미국S&P500데일리커버드콜OTM",           "예상 투자금 (원)": "120,000,000"},
        {"ETF 종목": "KODEX 미국배당다우존스타겟커버드콜",          "예상 투자금 (원)": "100,000,000"},
        {"ETF 종목": "TIGER 미국나스닥100커버드콜(합성)",           "예상 투자금 (원)": "90,000,000"},
        {"ETF 종목": "TIGER 미국테크TOP10타겟커버드콜",             "예상 투자금 (원)": "70,000,000"},
        {"ETF 종목": "KODEX 미국30년국채타겟커버드콜(합성 H)",      "예상 투자금 (원)": "70,000,000"},
        {"ETF 종목": "KODEX 미국배당커버드콜액티브",                "예상 투자금 (원)": "60,000,000"},
        {"ETF 종목": "KODEX 미국성장커버드콜액티브",                "예상 투자금 (원)": "50,000,000"},
    ])
    ...
    st.markdown(
        ...
        <div style="background:#eef4ff;border-left:4px solid #ff4b4b;padding:14px 18px;border-radius:8px;margin:8px 0 12px 0;word-break:keep-all;overflow-wrap:break-word;">
          ...
          <div style="font-size:0.9rem;color:#31333f;line-height:1.6;">
            <b>목표 투자금액 7억</b> <span style="white-space:nowrap;">(미국 100%)</span> — 현금흐름 중심 <span style="white-space:nowrap;">커버드콜</span> · <b>연배당금액 최대화</b><br/>
            <br/>
            <b>선정 기준</b> (우선순위 순, 2026-09 시장 조정 반영)<br/>
            &nbsp;&nbsp;① 세후 1Y 배당률(1년 전 주가 기준) 가중 비중 분배<br/>
            &nbsp;&nbsp;② 월배당 ETF<br/>
            &nbsp;&nbsp;③ 컨셉별 3M 낙폭 최소화 종목 선정<br/>
            &nbsp;&nbsp;④ 시가총액 ≥ 1,000억원<br/>
            &nbsp;&nbsp;⑤ 컨셉별 대표 종목만 유지 (중복 통합)<br/>
            <br/>
            <b>제외</b>: 단일종목 ETF(팔란티어·테슬라 등), 미국 외 해외(대만·중국·일본·유럽·인도·글로벌)<br/>
            <b>편입 단위</b>: 종목별 최소 5천만원 / <span style="white-space:nowrap;">천만원 단위 내림</span> <span style="white-space:nowrap;">(잔액은 배당률 상위 순 배분)</span>
          </div>
        </div>
        """,
        unsafe_allow_html=True,
...
<div style="text-align:center; padding:20px 0; font-size:0.78rem; color:#666;
  ...
  Built with Claude Code by 이종호 (<a href="https://jhawk.kr" style="color:#666;">jhawk.kr</a>)
</div>
""", unsafe_allow_html=True)
