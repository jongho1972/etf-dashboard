...
with tab2:
    ...
    default_rows = pd.DataFrame([
        ...
        {"ETF 종목": "TIGER 미국나스닥100커버드콜(합성)",           "예상 투자금 (원)": "100,000,000"},
        {"ETF 종목": "KODEX 미국30년국채타겟커버드콜(합성 H)",      "예상 투자금 (원)": "90,000,000"},
        {"ETF 종목": "TIGER 미국S&P500타겟데일리커버드콜",          "예상 투자금 (원)": "80,000,000"},
        {"ETF 종목": "TIGER 미국테크TOP10타겟커버드콜",             "예상 투자금 (원)": "80,000,000"},
        {"ETF 종목": "KODEX 미국배당커버드콜액티브",                "예상 투자금 (원)": "70,000,000"},
