...
with tab2:
    ...
    default_rows = pd.DataFrame([
        ...
        {"ETF 종목": "RISE 미국AI밸류체인데일리고정커버드콜",  "예상 투자금 (원)": "90,000,000"},
        {"ETF 종목": "KODEX 미국S&P500데일리커버드콜OTM",      "예상 투자금 (원)": "80,000,000"},
        {"ETF 종목": "SOL 미국30년국채커버드콜(합성)",         "예상 투자금 (원)": "70,000,000"},
        {"ETF 종목": "TIGER 배당커버드콜액티브",               "예상 투자금 (원)": "70,000,000"},
        {"ETF 종목": "ACE KRX금현물",                          "예상 투자금 (원)": "70,000,000"},
        {"ETF 종목": "KODEX 미국배당다우존스타겟커버드콜",     "예상 투자금 (원)": "60,000,000"},
        {"ETF 종목": "ACE 미국반도체데일리타겟커버드콜(합성)", "예상 투자금 (원)": "50,000,000"},
    ])
