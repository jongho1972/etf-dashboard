...
with tab2:
    ...
    default_rows = pd.DataFrame([
        {"ETF 종목": "RISE 미국AI밸류체인데일리고정커버드콜",    "예상 투자금 (원)": "125,000,000"},
        {"ETF 종목": "RISE 미국테크100데일리고정커버드콜",      "예상 투자금 (원)": "105,000,000"},
        {"ETF 종목": "ACE 미국반도체데일리타겟커버드콜(합성)",   "예상 투자금 (원)": "100,000,000"},
        {"ETF 종목": "KODEX 미국나스닥100데일리커버드콜OTM",    "예상 투자금 (원)": "100,000,000"},
        {"ETF 종목": "KODEX 미국S&P500데일리커버드콜OTM",       "예상 투자금 (원)": "70,000,000"},
        {"ETF 종목": "TIGER 배당커버드콜액티브",                 "예상 투자금 (원)": "60,000,000"},
        {"ETF 종목": "KODEX 금융고배당TOP10타겟위클리커버드콜", "예상 투자금 (원)": "40,000,000"},
    ])
