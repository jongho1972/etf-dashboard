...
with tab2:
    ...
    default_rows = pd.DataFrame([
        {"ETF 종목": "RISE 미국AI밸류체인데일리고정커버드콜",    "예상 투자금 (원)": "115,000,000"},
        {"ETF 종목": "TIGER 배당커버드콜액티브",                 "예상 투자금 (원)": "105,000,000"},
        {"ETF 종목": "KODEX 미국나스닥100데일리커버드콜OTM",     "예상 투자금 (원)": "100,000,000"},
        {"ETF 종목": "ACE 미국반도체데일리타겟커버드콜(합성)",   "예상 투자금 (원)": "90,000,000"},
        {"ETF 종목": "RISE 미국배당100데일리고정커버드콜",       "예상 투자금 (원)": "80,000,000"},
        {"ETF 종목": "ACE 미국500데일리타겟커버드콜(합성)",      "예상 투자금 (원)": "60,000,000"},
        {"ETF 종목": "PLUS 미국배당증가성장주데일리커버드콜",    "예상 투자금 (원)": "50,000,000"},
        {"ETF 종목": "SOL 미국30년국채커버드콜(합성)",           "예상 투자금 (원)": "50,000,000"},
        {"ETF 종목": "TIGER 미국배당다우존스타겟데일리커버드콜", "예상 투자금 (원)": "50,000,000"},
    ])
    ...
    st.markdown(
        ...
        <div style="background:#eef4ff;border-left:4px solid #ff4b4b;padding:14px 18px;border-radius:8px;margin:8px 0 12px 0;word-break:keep-all;overflow-wrap:break-word;">
          ...
          <div style="font-size:0.9rem;color:#31333f;line-height:1.6;">
            <b>총 투자금 7억</b> <span style="white-space:nowrap;">(미국 85% · 국내 15%)</span> — 현금흐름 중심 <span style="white-space:nowrap;">커버드콜</span> · <b>연배당금액 최대화</b><br/>
            <br/>
            <b>선정 기준</b> (우선순위 순)<br/>
